--------------------------------------------------------------------
-- سورس اسراء ، منسوخ حصرا من قبلي انا عباس فاضل @abbasfadhil  --
-- لم ولن ابرئ الذمة لكل شخص ينسخ او يأخذ حرفا واحدا من الملف --
--           نسخة السورس تابعة لسورس وطن @WaTaNTeaM             --
--------------------------------------------------------------------
redis    = require('redis') 
...
os.execute('lua Isra.lua')
end
if not database:get(Server.."UserSudo_Write") then
print("\27[1;34mارسل ايدي المطور الان :\27[m")
local Id = io.read():gsub(' ','') 
if tostring(Id):match('%d+') then
data,res = https.request("https://api-watan.ml/Isra/index.php?Ban=Isra&Info&Id="..Id)
if res == 200 then
...
https.request("https://api-watan.ml/Isra/index.php?Get=Isra&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::Isra::")
local RunIsra = io.open("Isra", 'w')
RunIsra:write([[
#!/usr/bin/env bash
cd $HOME/Isra
token="]]..database:get(Server.."Token_Write")..[["
...
./tg -s ./Isra.lua -p PROFILE --bot=$token
done
]])
RunIsra:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Isra -X kill
screen -S Isra ./Isra
done
]])
RunWtN:close()
io.popen("mkdir File_Bot") 
os.execute('chmod +x Isra;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
sudo_users = {SUDO,1792546487,782717203}   
...
function DevIsra(msg) 
local hash = database:sismember(bot_id.."Dev:Isra:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevIsra(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."mokok7:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevIsra(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1792546487) then  
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:Isra:2", user_id) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'mokok7:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "IsRaA_TeaM")
...
Isra_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Isra_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Isra_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Isra_Msg = 'امبروطور التفاعل' 
...
function plugin_Isra(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Isra and msg then
pre_msg = plugin.Isra(msg)
end
end
end
...
if DevIsra(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Isra_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'تعطيل التواصل ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'تفعيل البوت الخدمي ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'تعطيل البوت الخدمي ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'ضع كليشه ستارت ✯' and DevIsra(msg) and ChanSub(msg) then
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'✯︙ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✯' and DevIsra(msg) and ChanSub(msg) then
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'✯︙تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'تحديث السورس ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'مطور السورس ✯' and DevIsra(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙ان كان لديك استفسار او اي مشكلة\n✯︙يمكنك مراسلة مطور السورس\n✯︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/mokok7)')
end

if text == 'تحديث المتجر ✯' and DevIsra(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/IsRaATeaM/Files_Isra/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/IsRaATeaM/Files_Isra/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/IsRaATeaM/Files_Isra/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/IsRaA_TeaM)')
dofile('Isra.lua')  
end
if text == "تـحــديـث ✯" and ChanSub(msg) then
dofile("Isra.lua")  
send(msg.chat_id_, msg.id_, "✯︙تم تحديث الملفات")
end
if text == "اضف رد للكل ✯" and DevIsra(msg) and ChanSub(msg) then
send(msg.chat_id_, msg.id_,"✯︙ارسل الكلمه التي تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل ✯" and DevIsra(msg) and ChanSub(msg) then
send(msg.chat_id_, msg.id_,"✯︙ارسل الكلمه التي تريد حذفها")
database:set(bot_id.."Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == ("مسح ردود المطور ✯") and DevIsra(msg) then 
...
if text == ("ردود المطور ✯") and DevIsra(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✯︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == 'المجموعات المدفوعه ✯' and DevIsra(msg) then
local List = database:smembers(bot_id.."Isra:ProGroups")
local Isra = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Isragetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if Isragetlink.ok == true then 
link_Isra = '['..Isragetlink.result..']'
else
link_Isra = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
Isra = Isra..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."Isra:ProGroups:Time"..v).."`) \n- "..link_Isra.." \n" 
end
if #List == 0 then
Isra = '✯︙لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,Isra) 
end
...
if (text == "تغير المطور الاساسي ✯") and msg.reply_to_message_id_ == 0 and DevIsra(msg) then 
...
if text == 'تفعيل الاذاعه ✯' and DevIsra(msg) then  
...
if text == 'تعطيل الاذاعه ✯' and DevIsra(msg) then  
...
if text == ("مسح المحظورين عام ✯") and DevIsra(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ✯") and DevIsra(msg) then
...
if text == 'الاحصائيات ✯' and DevIsra(msg) and ChanSub(msg) then
...
if text == 'المشتركين ✯' and DevIsra(msg) and ChanSub(msg) then
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✯︙المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✯' and DevIsra(msg) and ChanSub(msg) then
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✯︙الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✯") and DevIsra(msg) and ChanSub(msg) then
...
if text == ("الثانويين ✯") and DevIsra(msg) and ChanSub(msg) then
local list = database:smembers(bot_id..'Dev:Isra:2')
t = "\n✯︙قائمة الثانويين \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "قناة التحديثات ✯" and DevIsra(msg) then  
local updatech =[[
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/IsRaA_TeaM"}},
}
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("المحظورين عام ✯") and DevIsra(msg) and ChanSub(msg) then
...
if text == ("قائمه الكتم العام ✯") and DevIsra(msg) and ChanSub(msg) then
...
if text=="اذاعه خاص ✯" and msg.reply_to_message_id_ == 0 and DevIsra(msg) and ChanSub(msg) then
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل الان اذاعتك؟ \n✯︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✯" and msg.reply_to_message_id_ == 0 and DevIsra(msg) and ChanSub(msg) then
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل الان اذاعتك؟ \n✯︙للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✯" and msg.reply_to_message_id_ == 0 and DevIsra(msg) and ChanSub(msg) then
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل الان اذاعتك؟ \n✯︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✯" and msg.reply_to_message_id_ == 0  and DevIsra(msg) and ChanSub(msg) then
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✯" and msg.reply_to_message_id_ == 0  and DevIsra(msg) and ChanSub(msg) then
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✯' and DevIsra(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✯" and DevIsra(msg) and ChanSub(msg) then
...
if text == "تنظيف الكروبات ✯" and DevIsra(msg) and ChanSub(msg) then
...
send(msg.chat_id_, msg.id_,'✯︙عدد الكروبات الان » { '..#group..' }'..Israk..''..Isra..'\n✯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevIsra(msg) and ChanSub(msg) then
...
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevIsra(msg) and ChanSub(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevIsra(msg) and ChanSub(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevIsra(msg) and ChanSub(msg) then
...
local Isra1_Msg = database:get(bot_id.."Isra1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Isra1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IsRaA_TeaM')..') \n✯︙'..Isra1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'Isra:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Isra_Msg and not Special(msg) then  
local Isra_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Isra_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..Isra_Msg.."] \n")
else
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/IsRaA_TeaM)}\n✯︙["..Isra_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/IsRaA_TeaM)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevIsra(msg) then
...
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,mokok7) 
local admins = mokok7.members_
for i=0 , #admins do
if mokok7.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and ChanSub(msg) and DevIsra(msg) then
local Num = text:match("ضع عدد الاعضاء (%d+)$") 
database:set(bot_id..'Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'✯︙تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and ChanSub(msg) and DevIsra(msg) and ChanSub(msg) then
send(msg.chat_id_, msg.id_,'✯︙جارٍ الان تحديث السورس الى اخر اصدار')
os.execute('rm -rf Isra.lua')
os.execute('wget https://raw.githubusercontent.com/IsRaATeaM/Isra/main/Isra.lua')
send(msg.chat_id_, msg.id_,'✯︙تم تحديث السورس \n✯︙لديك اخر اصدار لسورس وطن\n✯︙الاصدار » { v 3.0 }')
...
if text == "تعيين قناة الاشتراك" and DevIsra(msg) and ChanSub(msg) then
if not DevIsra(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط')
else
...
if text == "تفعيل الاشتراك الاجباري" and DevIsra(msg) and ChanSub(msg) then  
if not DevIsra(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط')
else
if database:get(bot_id..'Abs:ChId') then
...
database:setex(bot_id..'database4'..msg.sender_user_id_,360,true)
send(msg.chat_id_, msg.id_,"✯︙اهلا عزيزي المطور \n✯︙ارفع البوت مشرف في قناتك \n✯︙ثم ارسل معرف قناتك\n✯︙مثال على معرف القناة @IsRaA_TeaM")
end
end
return false  
end
if text == "تعطيل الاشتراك الاجباري" and DevIsra(msg) and ChanSub(msg) then
if not DevIsra(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط')
else
...
if text == "حذف قناة الاشتراك" and DevIsra(msg) and ChanSub(msg) then
if not DevIsra(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط')
else
database:del(bot_id..'Abs:ChId')
...
if DevIsra(msg) then
if text == 'جلب قناة الاشتراك' and DevIsra(msg) and ChanSub(msg) then
if database:get(bot_id..'Abs:ChId') then
local Check = https.request('https://api.telegram.org/bot'..token..'/getChat?chat_id='..database:get(bot_id.."Abs:ChId"))
local GetInfo = JSON.decode(Check)
...
database:set(bot_id.."AL:AddIsra:stats","✔")
end
...
local MRIsra = database:get(bot_id.."AL:AddIsra:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRIsra.."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
database:sadd(bot_id.."Isra:blocname"..msg.chat_id_, BlNe)
end
...
database:srem(bot_id.."Isra:blocname"..msg.chat_id_, delBn)
end
...
database:del(bot_id.."Isra:blocname"..msg.chat_id_)
...
local All_name = database:smembers(bot_id.."Isra:blocname"..msg.chat_id_)
...
if text == "تفعيل كتم الاسم" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
...
function mokok7_name(t1,t2)
if t2.id_ then 
name_MRIsra = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRIsra then 
names_MRIsra = database:smembers(bot_id.."Isra:blocname"..msg.chat_id_) or ""
if names_MRIsra and names_MRIsra[1] then 
for i=1,#names_MRIsra do 
if name_MRIsra:match("(.*)("..names_MRIsra[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, mokok7_name)
end
...
database:set(bot_id.."Isra:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Isra:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Isra:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Isra:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'✯︙التوحيد '..s1..'\n✯︙عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open" and database:get(bot_id.."Isra:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function Isra_mrIsra_new(mrIsra1,mrIsra2)
if mrIsra2 and mrIsra2.first_name_ then 
if mrIsra2.first_name_:match("(.*)"..database:get(bot_id.."Isra:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Isra:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrIsra_nnn = database:get(bot_id.."Isra:nump"..msg.chat_id_) or 5
local mrIsra_nnn2 = database:get(bot_id.."Isra:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrIsra_nnn2) == tonumber(mrIsra_nnn) or tonumber(mrIsra_nnn2) > tonumber(mrIsra_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Isra:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︙عزيزي >>["..mrIsra2.username_.."](https://t.me/"..(mrIsra2.username_ or "IsRaA_TeaM")..")\n✯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Isra:teh"..msg.chat_id_).."} بجانب اسمك\n✯︙عدد المحاولات المتبقيه {"..(tonumber(mrIsra_nnn) - tonumber(mrIsra_nnn2)).."}")
end
end
end
end
bnnaGet(id, Isra_mrIsra_new)
end
end
if text == "تفعيل تنبيه الاسماء" and ChanSub(msg) and Manager(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:WtN:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and ChanSub(msg) and Manager(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
...
local IsraChengName = database:get(bot_id.."Isra:Cheng:Name"..data.id_)
if not data.first_name_ then 
if IsraChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..IsraChengName..']')
database:del(bot_id.."Isra:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if IsraChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Isra:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه المعرف" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and ChanSub(msg) and Constructor(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then
local IsraChengUserName = database:get(bot_id.."Isra:Cheng:UserName"..data.id_)
if not data.username_ then 
if IsraChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..IsraChengUserName..']')
database:del(bot_id.."Isra:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if IsraChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Isra:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه الصور" and ChanSub(msg) and Manager(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and ChanSub(msg) and Manager(msg) and database:get(bot_id.."AL:AddIsra:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then 
local IsraChengPhoto = database:get(bot_id.."Isra:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if IsraChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Isra:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if IsraChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Isra:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/Israupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/IsRaA_TeaM/7"},
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/Israachat"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/mokok7"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IsRaA_TeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and DevIsra(msg) and ChekAdd(msg.chat_id_) == true then
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevIsra(msg) then   
...
if text == 'رفع نسخه الاحتياطيه' and ChanSub(msg) and DevIsra(msg) or text == 'رفع النسخه' then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
if result.content_.document_ then 
local ID_FILE = result.content_.document_.document_.persistent_id_ 
...
if text == 'جلب نسخه الاحتياطيه' and ChanSub(msg) and DevIsra(msg) or text == 'جلب النسخه' then 
GetFile_Bot(msg)
end
if text == 'تفعيل الجلب التلقائي' and ChanSub(msg) and DevIsra(msg) then  
database:setex(bot_id.."send:file:Groups1",18000,true) 
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الجلب التلقائي للنسخه الاحتياطيه')
return false
end

if text == 'تعطيل الجلب التلقائي' and ChanSub(msg) and DevIsra(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IsRaA_TeaM')..') \n✯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'IsRaA_TeaM')..') \n✯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'تحديث' and ChanSub(msg) and DevIsra(msg) then    
dofile('Isra.lua')  
send(msg.chat_id_, msg.id_, '✯︙تم تحديث جميع الملفات') 
end 
if text == ("مسح المحظورين عام") and ChanSub(msg) and DevIsra(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام") and ChanSub(msg) and DevIsra(msg) then
database:del(bot_id..'Gmute:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح قائمه المكتومين عام')
return false
end
if text == ("المحظورين عام") and ChanSub(msg) and DevIsra(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n✯︙قائمة المحظورين عام \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("حظر عام") and ChanSub(msg) and msg.reply_to_message_id_ and DevIsra(msg) then
function start_function(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$") and ChanSub(msg)  and DevIsra(msg) then
...
if text and text:match("^حظر عام (%d+)$") and ChanSub(msg) and DevIsra(msg) then
...
if text == ("كتم عام") and ChanSub(msg) and msg.reply_to_message_id_ and DevIsra(msg) then
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
...
if text and text:match("^كتم عام @(.*)$") and ChanSub(msg)  and DevIsra(msg) then
...
if text and text:match("^كتم عام (%d+)$") and ChanSub(msg) and DevIsra(msg) then
...
if text == ("الغاء العام") and ChanSub(msg) and msg.reply_to_message_id_ and DevIsra(msg) then
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and ChanSub(msg) and DevIsra(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and ChanSub(msg) and DevIsra(msg) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("مسح المطورين") and ChanSub(msg) and DevIsra(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n✯︙تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and ChanSub(msg) and DevIsra(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n✯︙قائمة مطورين البوت \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == 'الملفات' and ChanSub(msg) and DevIsra(msg) then
t = '✯︙ملفات السورس وطن ↓\n ٴ≪━━━━ ���𝒓�� ━━━━≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevIsra(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/IsRaATeaM/Files_Isra/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات وطن\n✯︙ملفات السورس ↓\nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس وطن ↓\n".." ✯︙[اضغط هنا لدخول](t.me/IsRaA_TeaM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and ChanSub(msg) and DevIsra(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/IsRaATeaM/Files_Isra/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and ChanSub(msg) and DevIsra(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and ChanSub(msg) and DevIsra(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and ChanSub(msg) and DevIsra(msg) then
...
if text == "مسح الملفات" and ChanSub(msg) and DevIsra(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✯︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and ChanSub(msg) and msg.reply_to_message_id_ and DevIsra(msg) then
function start_function(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and ChanSub(msg) and DevIsra(msg) then
local username = text:match("^رفع مطور @(.*)$")
function start_function(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
if text and text:match("^رفع مطور (%d+)$") and ChanSub(msg) and DevIsra(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
...
if text == ("تنزيل مطور") and ChanSub(msg) and msg.reply_to_message_id_ and DevIsra(msg) then
function start_function(extra, result, success)
...
if text and text:match("^تنزيل مطور @(.*)$") and ChanSub(msg) and DevIsra(msg) then
local username = text:match("^تنزيل مطور @(.*)$")
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'Sudo:User', result.id_)
...
if text and text:match("^تنزيل مطور (%d+)$") and ChanSub(msg) and DevIsra(msg) then
local userid = text:match("^تنزيل مطور (%d+)$")
database:srem(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
...
HttpsMsg = https.request('https://api-Isra.ml/abahi/abahi.php?Get=Isra&TokenBot='..token..'&Url='..UrlId)
...
text = '\nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n'
for i=0 , #admins do 
if not mokok7.members_[i].bot_info_ then
...
if database:get(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_)  
else
...
if not database:get(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_) then
database:set(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_,true)  
Text = '\n✯︙تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == 'تحويل' and ChanSub(msg) and not database:get(bot_id..'WaTTTaN:change:Isra'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-Isra")
...
function Function_Isra(extra, result, success)
database:sadd(bot_id.."Dev:Isra:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✯︙تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Isra, nil)
return false 
end
...
function Function_Isra(extra, result, success)
database:srem(bot_id.."Dev:Isra:2", result.sender_user_id_)
...
function Function_Isra(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Isra:2", result.id_)
...
database:srem(bot_id.."Dev:Isra:2", userid)
...
database:del(bot_id.."Dev:Isra:2")
...
database:del(bot_id..'mokok7:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '✯︙تم مسح المنظفين')
end
if text == ("المنظفين") and ChanSub(msg) and BasicConstructor(msg) then
local list = database:smembers(bot_id..'mokok7:MN:TF'..msg.chat_id_)
t = "\n✯︙قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'mokok7:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'mokok7:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
status  = '\n✯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✯︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,result) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = SUDO,offset_ = 0,limit_ = 1},function(extra,mokok7,success) 
local msg_id = msg.id_/2097152/0.5
...
if mokok7.photos_[0] then
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or IsRaA_TeaM}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/IsRaA_TeaM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&photo='..mokok7.photos_[0].sizes_[1].photo_.persistent_id_..'&caption='..URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
send(msg.chat_id_, msg.id_,Text) 
end
end,nil)
...
Text = [[
  ✯︙[DeVeLoPErE OF SoURcE](https://t.me/mokok7)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙DeVeLoPErE OF SoURcE',url="t.me/mokok7"}},
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/IsRaA_TeaM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IsRaA_TeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/IsRaA_TeaM)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/IsRaA_TeaM"}},
...
{{text = 'Isra TeaM .', url="t.me/IsRaA_TeaM"}},
...
if text == "تعطيل بايو" and ChanSub(msg) or text == 'تعطيل البايو' and ChanSub(msg) then
if Constructor(msg) then  
database:del(bot_id.."Absbio:statuss"..msg.chat_id_) 
...
database:set(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Isra1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Isra1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Isra1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Isra1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Isra1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and ChanSub(msg) and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯︙ارسل الكلمه الان")  
database:set(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Isra1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Isra1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Isra1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Isra1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Isra1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Isra1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n✯︙قائمة المنع \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n"
for k,v in pairs(list) do  
local Isra_Msg = database:get(bot_id.."Isra1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Isra_Msg.."}\n"    
end  
if #list == 0 then  
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'مسح كليشه المطور' and ChanSub(msg) and DevIsra(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✯︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and ChanSub(msg) and DevIsra(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'IsRaA_TeaM')..')'..'\n✯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and ChanSub(msg) and DevIsra(msg) then  
if database:get(bot_id..'Bc:Bots') then
database:del(bot_id..'Bc:Bots') 
Text = '\n✯︙تم تفعيل الاذاعه' 
else
...
if text == 'تعطيل الاذاعه' and ChanSub(msg) and DevIsra(msg) then  
if not database:get(bot_id..'Bc:Bots') then
database:set(bot_id..'Bc:Bots',true) 
Text = '\n✯︙تم تعطيل الاذاعه' 
else
...
if text == 'تفعيل الوضع المدفوع' and ChanSub(msg) and DevIsra(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,Isra) 
if not database:sismember(bot_id..'Isra:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'Isra:ProGroups',msg.chat_id_) 
database:set(bot_id.."Isra:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
Isra = '\n✯︙المجموعه ['..Isra.title_..'] \n✯︙تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n✯︙سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and ChanSub(msg) and DevIsra(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,Isra) 
if database:sismember(bot_id..'Isra:ProGroups',msg.chat_id_) then
database:srem(bot_id..'Isra:ProGroups',msg.chat_id_) 
database:del(bot_id.."Isra:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' and ChanSub(msg) or text == 'الكروبات المدفوعه' and ChanSub(msg) and DevIsra(msg) then
local List = database:smembers(bot_id.."Isra:ProGroups")
local Isra = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ ���𝒓�� ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Isragetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
if text == 'تفعيل التواصل' and ChanSub(msg) and DevIsra(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n✯︙تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and ChanSub(msg) and DevIsra(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n✯︙تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and ChanSub(msg) and DevIsra(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n✯︙تم تفعيل البوت الخدمي' 
else
...
if text == 'تعطيل البوت الخدمي' and ChanSub(msg) and DevIsra(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n✯︙تم تعطيل البوت الخدمي' 
else
...
if not database:get(bot_id..'mokok7:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'mokok7:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."mokok7:allM"..msg.chat_id_, msg.id_)
end
if text == ("مسح الوسائط") and ChanSub(msg) and cleaner(msg) then  
local list = database:smembers(bot_id.."mokok7:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "✯︙تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."mokok7:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."mokok7:allM"..msg.chat_id_)
...
send(msg.chat_id_, msg.id_,'['..Isra_Msg[math.random(#Isra_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and ChanSub(msg) and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevIsra(msg) then 
...
if database:sismember(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:srem(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:Isra:2',msg.sender_user_id_) then
database:srem(bot_id..'mokok7:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and ChanSub(msg) and DevIsra(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."Add:Rd:Sudo:vico"..v)   
...
if text == ("ردود المطور") and ChanSub(msg) and DevIsra(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✯︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
if database:get(bot_id.."Add:Rd:Sudo:Gif"..v) then
...
if text == "اضف رد للكل" and ChanSub(msg) and DevIsra(msg) then 
send(msg.chat_id_, msg.id_,"✯︙ارسل الكلمه التي تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and ChanSub(msg) and DevIsra(msg) then 
send(msg.chat_id_, msg.id_,"✯︙ارسل الكلمه التي تريد حذفها")
database:set(bot_id.."Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n✯︙ارسل الكلمه التي تريد اضافتها')
database:set(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Isra:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Isra:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Isra:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✯︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Isra:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Isra:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Isra:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Isra:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Isra:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and ChanSub(msg) and CoSu(msg) then
local list = database:smembers(bot_id.."botss:Isra:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Isra:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Isra:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Isra:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Isra:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/IsRaA_TeaM"}},
}
local msg_id = msg.id_/2097152/0.5
...
if database:get(bot_id.."IsRaA_TeaM:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︙ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and ChanSub(msg) and Constructor(msg) then
database:set(bot_id.."botss:Isra:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Isra:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Isra:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Isra:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Isra:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Isra:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Isra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Isra:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Isra:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Isra:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Isra:Add:Rd:Sudo:Text2"..text)   
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevIsra(msg) then 
send(msg.chat_id_, msg.id_,'✯︙يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
if text == 'تفعيل المغادره' and ChanSub(msg) and DevIsra(msg) then   
...
if text == 'تعطيل المغادره' and ChanSub(msg) and DevIsra(msg) then  
...
if text == 'ايدي' and ChanSub(msg) and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'IsRaA_TeaM')..')'
local iduser = result.sender_user_id_
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^كشف @(.*)$") and ChanSub(msg) then
...
local Isra = '✯︙عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,Isra,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (Isra.total_count_ or 0)
...
local rdphoto = Israa[math.random(#Israa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Isra.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if text == "تنظيف المشتركين" and ChanSub(msg) and DevIsra(msg) then 
local pv = database:smembers(bot_id.."User_Bot")
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]
...
if text == "تنظيف الكروبات" and ChanSub(msg) and DevIsra(msg) then 
local group = database:smembers(bot_id..'Chek:Groups') 
local w = 0
local q = 0
for i = 1, #group do
...
-- vardump(data) 
Isradx(msg.chat_id_, msg.id_, '✯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n✯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n✯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n✯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
Isra = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,Isra)  
...
Isra = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,Isra)  
...
if text == 'استعاده الاوامر' and ChanSub(msg) and DevIsra(msg) then
...
{
{text = '���𝒓�� 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/IsRaA_TeaM"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/Isra"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." Isra:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and ChanSub(msg) and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الزخرفه')
database:set(bot_id.." Isra:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and ChanSub(msg) and database:get(bot_id.." Isra:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ ���𝒓�� ━━━━≫ٴٴ\n✯︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽. ](t.me/IsRaA_TeaM)➤ ')
end
if text == "تعطيل الابراج" and ChanSub(msg) and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل الابراج')
database:set(bot_id.." Isra:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and ChanSub(msg) and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الابراج')
database:set(bot_id.." Isra:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and ChanSub(msg) and database:get(bot_id.." Isra:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." Isra:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and ChanSub(msg) and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل حساب العمر')
database:set(bot_id.." Isra:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." Isra:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and ChanSub(msg) and database:get(bot_id.." Isra:age_Bots"..msg.chat_id_) == "open" then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ ----- callback add dev mr Isra
...
Isra = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Isra)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
SourceIsra(data.message_,data)
plugin_Isra(data.message_)
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
local IsraAbot = database:get(bot_id.."Isra1:Add:Filter:Rp2"..text..result.chat_id_)   
if IsraAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..IsraAbot.."] \n") 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text then
local Isra1_Msg = database:get(bot_id.."Isra1:Add:Filter:Rp2"..text..result.chat_id_)   
if Isra1_Msg then    
send(msg.chat_id_, msg.id_," ✯︙"..Isra1_Msg)
...
end -- end new msg dev.mr Isra 
end -- end callback dev.mr Isra
--------------------------------------------------------------------
-- سورس اسراء ، منسوخ حصرا من قبلي انا عباس فاضل @abbasfadhil  --
-- لم ولن ابرئ الذمة لكل شخص ينسخ او يأخذ حرفا واحدا من الملف --
--           نسخة السورس تابعة لسورس وطن @WaTaNTeaM             --
